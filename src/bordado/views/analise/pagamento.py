...
__all__ = ['AnalisePagamentoView']


class AnalisePagamentoView(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.Form_class = AnalisePagamentoForm
        self.form_class_has_initial = True
        self.cleaned_data2self = True
        self.cleaned_data2context = True
        self.template_name = 'bordado/analise/pagamento.html'
        self.title_name = 'Pagamento - Análise'
